...
<body>
  <?php
    include ('connect.php');
    $query1 = "SELECT * From OfferteAttive WHERE Professionale = false ";
    $query2 = "SELECT * From DomandeAttive WHERE Professionale = false ";
  ...
  <p>Cerchi un livello di competenza professionale? Passa agli <a href="add_scambio_prof_form.php">scambi professionali</a>
  <form method="post" action="add_scambio.php">
    ...
    <input class="fb" type="range" min="1" max="5" step="1" name="FB1"></input><br>
    <label type="range" for="FB2">Feedback Simpatia:</label>
    <input class="fb" type="range" min="1" max="5" step="1" name="FB2"></input><br>
